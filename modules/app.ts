...
export default class App {
    ...
    loadResources() {
        ...
        App.sprites["grass"] = {
            width: 32 * 12,
            height: 32,
            image: grass.cloneNode() as HTMLImageElement,
            numberOfFrames: 12,
        ...
        App.sprites["bad_fruit"] = {
            width: 32 * 8,
            height: 32,
            image: bad_fruit.cloneNode() as HTMLImageElement,
            numberOfFrames: 8,
            msPerFrame: Game.STEP_TIME_MS / 8,
        };
        ...
        App.sprites["snake_head_eat_bad"] = {
            width: 32 * 15,
            height: 32,
            image: snake_head_eat_bad.cloneNode() as HTMLImageElement,
            numberOfFrames: 15,
            msPerFrame: Game.STEP_TIME_MS / 15,
        };
    ...
    render() {
        ...
        this.ctx.fillText(
            scoreText,
            (this.canvas.width + this.game.width) / 2 + 20,
            64,
            (this.canvas.width - this.game.width - headerMeasure.width) / 2 - 20
        );
